...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15=new JLabel();
        id15.setBounds(0,0,1500,700);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("icons/add_employee.jpg"));
        Image imsc = img.getImage().getScaledInstance(1400,750,Image.SCALE_SMOOTH);
        ImageIcon iic = new ImageIcon(imsc);
        id15.setIcon(iic);

        id8 = new JLabel("New Employee Details");
        id8.setBounds(520,30,500,50);
        ...
        id11= new JLabel("Father's Name");
        id11.setBounds(400,350,180,30);
        ...
        id16=new JLabel("Department");
        id16.setBounds(800,150,150,30);
        id16.setFont(new Font("serif", Font.BOLD,20));
        id15.add(id16);

        t13=new JTextField();
        t13.setBounds(980,150,150,30);
        id15.add(t13);id13.setFont(new Font("serif", Font.BOLD,20));
  
       /* id17=new JLabel("Presenty");
        id17.setBounds(800,200,140,30);
        id17.setFont(new Font("serif", Font.BOLD,20));
        id15.add(id17);

        t14=new JTextField();
        t14.setBounds(980,200,150,30);
        id15.add(t14); */
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String sal = t12.getText();
        String dep = t13.getText();
        //String pres = t14.getText();
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into employee(emp_id,name,age,dob,phone,email,address,post,eduction,fname,aadhar,salary,Dept_name) values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+sal+"','"+dep+"')";
