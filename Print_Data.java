...
class Print_Data implements ActionListener{
    ...
    String emp_id,name,father,address,phone,email,education,post,age,dob,aadhar,salary,dept_n,presence;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        try{
            ...
            while(rs.next()){
                ...
                education = rs.getString("eduction");
                post = rs.getString("post");
                aadhar = rs.getString("aadhar");
                emp_id = rs.getString("emp_id");
                salary = rs.getString("salary");
                dept_n = rs.getString("Dept_name");
                presence = rs.getString("presenty");
            }
        }catch(Exception e){
            e.printStackTrace();
        }
        ...
        aid11 = new JLabel(salary+"/-");
        aid11.setBounds(330,470,300,30);
        aid11.setFont(new Font("serif",Font.BOLD,20));
        id9.add(aid11);

        id11 = new JLabel("Attendence in last 30 : ");
        id11.setBounds(50,520,280,30);
        id11.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id11);

        aid12 = new JLabel(presence+" days");
        aid12.setBounds(330,520,300,30);
