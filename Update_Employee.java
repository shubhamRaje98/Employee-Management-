...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        id4= new JLabel("Email_ID:");
        id4.setBounds(400,150,150,30);
        ...
        id9= new JLabel("Father Name:");
        id9.setBounds(400,250,170,30);  
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee set name='"+t2.getText()+"',fname='"+t8.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t5.getText()+"',phone='"+t3.getText()+"',email='"+t4.getText()+"',eduction='"+t7.getText()+"',post='"+t6.getText()+"',aadhar='"+t9.getText()+"',emp_id='"+t1.getText()+"' where emp_id='"+id_emp+"'";
