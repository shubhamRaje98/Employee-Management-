...
class Remove_Employee implements ActionListener{
    ...
    Remove_Employee(){
        ...
        l5.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("icons/professionals.jpg"));
        l5.setIcon(img);
        f.add(l5);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==c1){
            try{
                ...
                input = (String)cb.getSelectedItem();
                String str = "select name,phone,email from employee where emp_id ='"+input+"' ";
                ResultSet rs = con.s.executeQuery(str);
        ...
        if(ae.getSource()==b1){
            try{
                conn con = new conn();
                //JComboBox cb = (JComboBox)ae.getSource();
                String str = "delete from employee where emp_id = '"+input+"'";
